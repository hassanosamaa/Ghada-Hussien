export default {
  ...
  CONTACT: "CONTACT",
  APIPerformanceTesting: "Tests API & Performance",
  ProgrammingAutomation: "Programmation & Automatisation",
  ProjectDefectTrackingTools:
    "Outils de gestion de projets & suivi des défauts",
  DatabasesAndConcepts: "Bases de données & Concepts",
  YourMessage: "Votre message :",
  Write: "Écrire . . .",
  ClickToSendAnEmail: "Cliquez pour envoyer un e-mail",
} as const;
